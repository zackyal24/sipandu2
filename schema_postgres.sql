...
CREATE TABLE monitoring_data_panen (
    ...
    foto_penyampaian_uang VARCHAR(255) NOT NULL,
    foto_ktp_petani VARCHAR(255) NOT NULL,
    foto_timbangan_ubinan VARCHAR(255) NOT NULL,
    foto_proses_ubinan VARCHAR(255) NOT NULL,
    foto_plot_setelah_panen VARCHAR(255) NOT NULL,
