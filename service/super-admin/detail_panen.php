...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .table th {
                width: 35% !important; /* Sedikit lebih lebar di mobile */
                font-size: 0.85rem;
        ...
        /* PDF print - ukuran optimal untuk export */
        @media print {
            .table th {
                width: 30% !important;
            }
                                ...
                                <tr><th>Berat Ubinan</th>
                                    <td>
                                        <?php if (!empty($data['berat_plot']) && $data['berat_plot'] != 0): ?>
                                            <span class="fw-bold text-primary"><?= htmlspecialchars($data['berat_plot']); ?> kg</span>
                                        <?php else: ?>
